...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="{{ route('siswa.export', ['status' => request('status'), 'id_kelas' => request('id_kelas')]) }}" class="btn btn-success mb-3" onclick="showSuccess()">Export Data Siswa</a>
        ...
        <div class="d-flex justify-content-center">
            {{ $siswa->appends(['perPage' => request('perPage')])->links('vendor.pagination.default') }}
        </div>
    </div>
